    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 10, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "A conference about the latest in technology.", "New York City", 200, "Tech Conference 2024" },
                    { 2, new DateTime(2025, 11, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "An expo focused on health and wellness products and services.", "Los Angeles", 150, "Health & Wellness Expo" }
                });
